            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-container p-5">
                        ...
                        <form action="verifica_login.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <input type="submit" name="Enviar" value="Logar" class="btn btn-primary w-100">
                            <a class="btn btn-secondary w-100 mt-2" href="../../frontend/html/index.php">Voltar</a>
                            <h6 class="mt-2 text-center">Ainda não tem uma conta? <a href="../../backend/cadastro/tela_cadastro.php">Clique aqui!</a></h6>
                        </form>
                    </div>
                </div>
                <div class="col-md-6">
