...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $pesquisar = $_POST['pesquisar'] ?? '';
    $resultado_pesquisa = $respositorioUsuario->pesquisarComum($pesquisar);
...
<head>
    ...
    <title>Pesquisar Nome Comum</title>
</head>
                    ...
                    while ($rows_pesquisa = mysqli_fetch_array($resultado_pesquisa)) { ?>
                        <tr>
                            ...
                            <td><?php
                                ...
                                ?>
                                    <a class="text-success" href="atualiza_tipo.php?id=<?php echo $rows_pesquisa['id']; ?>&tipo=0">Administrador</a>
                                <?php
                                } else {
                                ?>
                                    <a class="text-primary" href="atualiza_tipo.php?id=<?php echo $rows_pesquisa['id']; ?>&tipo=1">Comum</a>
                                <?php
                                }
                                ?>
                            </td>
