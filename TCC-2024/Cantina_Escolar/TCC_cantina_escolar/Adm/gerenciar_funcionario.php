...
$registro = $respositorioUsuario->listarFuncionario();
$registro =  $respositorioFuncionario->listarFuncionarios();
?>
...
<body>
    ...
    <div class="adicionar">
        <div class="row">
            ...
            <div class="col-md-4">
                <form method="POST" action="./funcio/pesquisar_nome.php">
                    <div class="search">
                ...
                <?php while ($listagem = $registro->fetch_object()) { ?>
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?>
                                <a class="text-success" href="./funcio/alterar_status.php?id=<?php echo $listagem->id; ?>&status=0">Ativado</a>
                            <?php
                            } else {
                            ?>
                                <a class="text-danger" href="./funcio/alterar_status.php?id=<?php echo $listagem->id; ?>&status=1">Desativado</a>
                            <?php
                            }
                            ?>
                        </td>
                        <td><button class="remove "> <a href="./funcio/excluir_usuario.php?id_usuario=<?php echo $listagem->id ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
