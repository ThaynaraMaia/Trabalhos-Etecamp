...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $pesquisar = $_POST['pesquisar'] ?? '';
    $resultado_pesquisa = $respositorioFuncionario->pesquisarAdm($pesquisar);
...
<head>
    ...
    <title>Pesquisar Nome do ADM</title>
</head>
...
<body>
    ...
    ?>
        <div class="page-title">Administrador não encontrado.</div>
    <?php
    }
    ?>
