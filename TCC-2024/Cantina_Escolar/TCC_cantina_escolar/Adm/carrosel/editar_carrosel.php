...
<body>
    ...
    <div class="profile-container">
        <h5>Escolha as Imagens do Carrossel</h5>
        <br>
        <form action="imagem_carrosel_editado.php" method="POST" enctype="multipart/form-data">
            <div class="profile-details">

                <div class="row">
                    <div class="col-12">
                        <label for="imagem1">Imagem 1:</label>
                        <input type="file" class="form-control mb-2" name="imagem1" required>
                    </div>

                    <div class="col-12">
                        <label for="imagem1">Imagem 2:</label>
                        <input type="file" class="form-control mb-2" name="imagem2" required>
                    </div>

                    <div class="col-12">
                        <label for="imagem1">Imagem 3:</label>
                        <input type="file" class="form-control mb-2" name="imagem3" required>
                    </div>
                </div>
        ...
        <div id="footer_items">
            <div class="rodape-div-2-coluna">
                ...
                <p class="nav-item">
                    ...
                    <a class="nav-item active" href="Telefone.php">Telefone: +55 (11) 4039-7898
                </p>
                <p class="nav-item">
                    ...
                    <a class="nav-item active">Celular: +55 (11) 999167898</a>
                </p>
            </div>
            <div id="footer_items">
                <div class="rodape-div-3-coluna">
                    ...
                    <p class="nav-item">
                        ...
                        <a class="nav-item active" href="Instagram.php">Instagram: @etecamp_oficial
                    </p>
                    <p class="nav-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
                        </svg>
                        <a class="nav-item active" href="Fecebook.php">Facebook: Etec de Campo Limpo Paulista
                    </p>
                </div>
            </div>
        </div>
