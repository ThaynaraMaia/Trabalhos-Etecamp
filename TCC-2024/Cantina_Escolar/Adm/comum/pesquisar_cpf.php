...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $pesquisar = $_POST['pesquisar'] ?? '';
    $resultado_pesquisa = $respositorioUsuario->pesquisarCpf($pesquisar);
...
<head>
    ...
    <title>Pesquisar CPF do Comum</title>
</head>
...
<body>
    ...
    ?>
        <div class="adicionar">
            <div class="row">
                ...
                <div class="col-6">
                    <form method="POST" action="pesquisar_cpf.php">
                        <div class="search">
                            ...
                            <input type="text" id="searchInput" name="pesquisar" placeholder="Pesquise pelo cpf">
                    </form>
                </div>
            </div>
        </div>
        <div class="tabela">
            <table>
                ...
                <tbody>
                    <?php while ($rows_pesquisa = mysqli_fetch_array($resultado_pesquisa)) {
                    ?>
                        <tr>
                            <td><?php echo $rows_pesquisa['cpf']; ?></td>
                            <td><?php echo $rows_pesquisa['nome_completo']; ?></td>
                            <td><?php echo $rows_pesquisa['email']; ?></td>
                            <td>R$ <?php echo $rows_pesquisa['saldo']; ?></td>
                            <td><a href="../adicionar_saldo.php?id_usuario=<?php echo $rows_pesquisa['id']; ?>"><button class="botao-saldo">+ Adicionar Saldo</button></a></td>
                            <td><button class="remove "> <a href="excluir_usuario2.php?id_usuario=<?php echo $rows_pesquisa['id']; ?>"> <i class="bx bx-x "></i></a></button></td>
                        </tr>
                    <?php
                    }
                    ?>
    ...
    ?>
        <div class="page-title">Usuário não encontrado.</div>
    <?php
    }
    ?>
