...
<head>
    ...
    <title>Pesquisar CPF do Pedido</title>
</head>
...
<body>
    ...
    ?>
        <div class="adicionar">
            <div class="row">
                ...
                <div class="col-6">
                    <form method="POST" action="pesquisar_cpf_pedido.php">
                        <div class="search">
                            ...
                            <input type="text" id="searchInput" name="pesquisar" placeholder="Pesquisar CPF">
                    </form>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    <?php while ($rows_pesquisa = mysqli_fetch_array($resultado_pesquisa)) { ?>
                        <tr>
                            ...
                            <td><a href="../listar_pedidos.php?id_usuario=<?php echo $rows_pesquisa['id']; ?>"><button class="botao-ver">Ver Pedidos</button></a></td>
    ...
    <?php  } else {
    ?>
        <div class="page-title">CPF não encontrado.</div>
    <?php
    }
    ?>
