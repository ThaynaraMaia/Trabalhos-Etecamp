...
<body>
    ...
    <div class="adicionar">
        <div class="row">
            ...
            <div class="col-6">
                <form method="POST" action="./comum/pesquisar_cpf_pedido.php">
                    <div class="search">
            ...
            <tbody>
                <?php while ($listagem = $registro->fetch_object()) { ?>
                    <tr>
                        ...
                        <td><a href="./listar_pedidos.php?id_usuario=<?php echo $listagem->id; ?>"><button class="botao-ver">Ver Pedidos</button></a></td>
                    </tr>
                <?php
                }
                ?>
