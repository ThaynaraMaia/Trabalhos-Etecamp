...
const Games = [
    ...
    {   
        ...
        gameOptions: `
                ...
                <label for="inputText" required="true"><br><br><strong>Nickname</strong></label>
                    <input type="text" id="inputText" name="inputText" required="true"><br><br>
                


                <label for="menu3"><strong>Rank</strong></label>
                <select id="menu1" name="menu1" required="true"><br><br>
...
const selectGame = document.getElementById('menuG')
// let lastFilter = 1;
// let currentFilter = 1;
...
selectGame.addEventListener('change', () => {
    filterDiv.innerHTML = Games[selectGame.value].gameOptions;
})
...
// function send() {
// let inpGame = document.getElementsByName('favgame').value;
// let nick = document.getElementById('inputText').value;
// let rank = document.getElementById('menu1').value;
...
// let check6 = document.getElementById('check6').value;
// let check7 = document.getElementById('check7').value;
// let check8 = document.getElementById('check8').value;
// let check9 = document.getElementById('check9').value;
// let check10 = document.getElementById('check10').value;
// let check11 = document.getElementById('check11').value;
// let query = []
...
//     //     console.log(rank);
//     // }
//     window.location.href = `friends.php?query=${query}`;
