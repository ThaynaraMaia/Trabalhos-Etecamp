...
$registro = $respositorioConteudo->listarTodosAlongamento();
?>
...
<head>
    ...
    <title>Equilibrio - Alongamento exercicios</title>
    ...
    <main id="content">
        <section id="home">
            <div id="ctaBipolaridade">
                <h1 class="title">
                    <span>Passo a Passo Alongamento</span>
                </h1>
                <?php 
while ($listagem = $registro->fetch_object()) {
?>
    <form action="alongamentoEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_alongamento; ?>" id="name" type="text" name="nome_alongamento" required>  
                    </div>
                    <div class="input-box">
                        <label for="alongamento">Alongamento</label>
                        <input value="<?php echo $listagem->alongamento; ?>" id="alongamento" type="text" name="alongamento" required>  
                    </div>
                </div>
            </h1>
