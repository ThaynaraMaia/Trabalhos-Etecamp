...
$registro = $respositorioConteudo->listarTodosSonoregular();
?>
    ...
    <main id="content">
        <section id="home">
            <div id="ctaBipolaridade">
                <h1 class="title">
                    <span>Sono regular</span>
                </h1>
                <?php 
while ($listagem = $registro->fetch_object()) {
?>
    <form action="sonoregularEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_sonoregular; ?>" id="name" type="text" name="nome_sonoregular" required>  
                    </div>
                    <div class="input-box">
                        <label for="sonoregular">Sono regular</label>
                        <input value="<?php echo $listagem->sonoregular; ?>" id="sonoregular" type="text" name="sonoregular" required>  
                    </div>
                </div>
            </h1>
