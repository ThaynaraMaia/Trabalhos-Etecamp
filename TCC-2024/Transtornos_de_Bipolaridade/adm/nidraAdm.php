...
$registro = $respositorioConteudo->listarTodosNidra();
?>
...
<head>
    ...
    <title>Equilibrio - Nidra yoga</title>
...
?>
    <form action="nidraEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_nidra; ?>" id="name" type="text" name="nome_nidra" required>  
                    </div>
                    <div class="input-box">
                        <label for="nidra">Nidra</label>
                        <input value="<?php echo $listagem->nidra; ?>" id="nidra" type="text" name="nidra" required>  
                    </div>
                </div>
            </h1>
