...
$registro = $respositorioConteudo->listarTodosRestaurativas();
?>
...
<head>
    ...
    <title>Equilibrio - Restaurativa yoga</title>
    ...
    <main id="content">
        <section id="home">
            <div id="ctaBipolaridade">
                <h1 class="title">
                    <span>Restaurativas</span>
                </h1>
                <?php 
while ($listagem = $registro->fetch_object()) {
?>
    <form action="restaurativasEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_restaurativas; ?>" id="name" type="text" name="nome_restaurativas" required>  
                    </div>
                    <div class="input-box">
                        <label for="restaurativas">Restaurativas</label>
                        <input value="<?php echo $listagem->restaurativas; ?>" id="restaurativas" type="text" name="restaurativas" required>  
                    </div>
                </div>
            </h1>
