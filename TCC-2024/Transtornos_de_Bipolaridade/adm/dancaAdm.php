...
$registro = $respositorioConteudo->listarTodosDanca();
?>
...
<head>
    ...
    <title>Equilibrio - Dança exercicios</title>
...
<?php 
        ...
        ?>
          <form action="dancaEditado.php?id_conteudos=<?php echo $listagem->id_conteudos;?>" method="POST">
                <section id="conteudoCaminhada">
                    <h1 class="section-title">
                        <div class="input-group">
                        <div class="input-box">
                                <label for="name">Nome</label>
                                <input value="<?php echo $listagem->nome_danca; ?>" id="name" type="text" name="nome_danca" required>  
                            </div>
                            <div class="input-box">
                                <label for="danca">Dança</label>
                                <input value="<?php echo $listagem->danca; ?>" id="name" type="text" name="danca" required>  
                            </div>
                        </div>
                    </h1>
