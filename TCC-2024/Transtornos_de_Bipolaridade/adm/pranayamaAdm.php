...
$registro = $respositorioConteudo->listarTodosPranayama();
?>
...
<head>
    ...
    <title>Equilibrio - Pranayama yoga</title>
...
?>
    <form action="pranayamaEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_pranayama; ?>" id="name" type="text" name="nome_pranayama" required>  
                    </div>
                    <div class="input-box">
                        <label for="pranayama">Pranayama</label>
                        <input value="<?php echo $listagem->pranayama; ?>" id="pranayama" type="text" name="pranayama" required>  
                    </div>
                </div>
            </h1>
