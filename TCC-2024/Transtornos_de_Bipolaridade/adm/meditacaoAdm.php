...
$registro = $respositorioConteudo->listarTodosMeditacao();
?>
...
<head>
    ...
    <title>Equilibrio - Meditação yoga</title>
...
?>
    <form action="meditacaoEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_meditacao; ?>" id="name" type="text" name="nome_meditacao" required>  
                    </div>
                    <div class="input-box">
                        <label for="meditacao">Meditação</label>
                        <input value="<?php echo $listagem->meditacao; ?>" id="meditacao" type="text" name="meditacao" required>  
                    </div>
                </div>
            </h1>
