...
$registro = $respositorioConteudo->listarTodosCaminhada();
?>
...
<head>
    ...
    <title>Equilibrio - Caminhada exercicios</title>
    ...
    <main id="content">
        <section id="home">
            <div id="ctaBipolaridade">
                <h1 class="title">
                    <span>Passo a passo Caminhada</span>
                </h1>

<?php 
        while ($listagem = $registro->fetch_object()){
        ?>
          <form action="caminhadaEditado.php?id_conteudos=<?php echo $listagem->id_conteudos;?>" method="POST">
                <section id="conteudoCaminhada">
                    <h1 class="section-title">
                        <div class="input-group">
                        <div class="input-box">
                                <label for="name">Nome</label>
                                <input value="<?php echo $listagem->nome_caminhada; ?>" id="name" type="text" name="nome_caminhada" required>  
                            </div>
                            <div class="input-box">
                                <label for="caminhada">Caminhada</label>
                                <input value="<?php echo $listagem->caminhada; ?>" id="name" type="text" name="caminhada" required>  
                            </div>
                        </div>
                    </h1>
