...
$registro = $respositorioConteudo->listarTodosSonobipolaridade();
?>
...
<head>
    ...
    <title>Equilibrio - Sono Bipolaridade </title>
    ...
    <main id="content">
        <section id="home">
            <div id="ctaBipolaridade">
                <h1 class="title">
                    <span>Sono bipolar</span>
                </h1>
                <?php 
while ($listagem = $registro->fetch_object()) {
?>
    <form action="sonobipolaridadeEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_sonobipolaridade; ?>" id="name" type="text" name="nome_sonobipolaridade" required>  
                    </div>
                    <div class="input-box">
                        <label for="sonobipolaridade">sono bipolaridade</label>
                        <input value="<?php echo $listagem->sonobipolaridade; ?>" id="sonobipolaridade" type="text" name="sonobipolaridade" required>  
                    </div>
                </div>
            </h1>
