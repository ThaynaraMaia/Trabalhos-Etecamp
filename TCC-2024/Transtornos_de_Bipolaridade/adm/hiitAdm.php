...
$registro = $respositorioConteudo->listarTodosHiit();
?>
...
<head>
    ...
    <title>Equilibrio - Hiits exercicios</title>
...
?>
    <form action="hiitEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_hiit; ?>" id="name" type="text" name="nome_hiit" required>  
                    </div>
                    <div class="input-box">
                        <label for="hiit">Hiits</label>
                        <input value="<?php echo $listagem->hiit; ?>" id="hiit" type="text" name="hiit" required>  
                    </div>
                </div>
            </h1>
