...
$registro = $respositorioConteudo->listarTodosSonodicas();
?>
...
?>
    <form action="sonodicasEditado.php?id_conteudos=<?php echo $listagem->id_conteudos; ?>" method="POST">
        <section id="conteudoCaminhada">
            <h1 class="section-title">
                <div class="input-group">
                    <div class="input-box">
                        <label for="name">Nome</label>
                        <input value="<?php echo $listagem->nome_sonodicas; ?>" id="name" type="text" name="nome_sonodicas" required>  
                    </div>
                    <div class="input-box">
                        <label for="sonodicas">Sono dicas</label>
                        <input value="<?php echo $listagem->sonodicas; ?>" id="sonodicas" type="text" name="sonodicas" required>  
                    </div>
                </div>
            </h1>
