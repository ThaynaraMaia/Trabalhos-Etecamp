...
$registro = $respositorioConteudo->listarTodosRespiracao();
?>
...
<head>
    ...
    <title>Equilibrio - Respiração exercicios</title>
...
<?php 
        ...
        ?>
          <form action="respiracaoEditado.php?id_conteudos=<?php echo $listagem->id_conteudos;?>" method="POST">
                <section id="conteudoCaminhada">
                    <h1 class="section-title">
                        <div class="input-group">
                        <div class="input-box">
                                <label for="name">Nome</label>
                                <input value="<?php echo $listagem->nome_respiracao; ?>" id="name" type="text" name="nome_respiracao" required>  
                            </div>
                            <div class="input-box">
                                <label for="respiracao">Respiração</label>
                                <input value="<?php echo $listagem->respiracao; ?>" id="name" type="text" name="respiracao" required>  
                            </div>
                        </div>
                    </h1>
