...
$registro = $respositorioConteudo->listarTodosHiitcomum();
?>
...
<body>
    ...
    <section id="conteudoHiitsVideo">
        <div class="videoHiits">
            <video width="700" height="500" controls>
                <source src="../img/Treino HIIT para INICIANTES!!! - Carol Borba.mp4" type="video/mp4">
                <source src="movie.ogg" type="video/ogg">
            </video>
        </div>

        <div class="textoHiits">
            <h1>Treino HIIT para INICIANTES!!! - Carol Borba</h1>
            <p>Esse treino pode ser repetido por várias séries, conforme sua capacidade física.</p>

            <div class="icones-video">
                <div class="btn-youtube">
                    <a href="https://youtu.be/wRLKMbCi6pw?si=uVcAJ9xYcnxIIl62" target="_blank">Assista no youtube</a>
                </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoHiits">
                <h1 class="title-Hiits">
                <?php  echo $listagem->nome_hiit;?>
                </h1>
                <p>
                <?php  echo $listagem->hiit;?>
                </p>
                </section>
                <?php
                }
