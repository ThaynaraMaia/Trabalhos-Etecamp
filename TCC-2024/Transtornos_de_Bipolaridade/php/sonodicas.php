...
$registro = $respositorioConteudo->listarTodosSonodicascomum();
?>
...
<body>
    ...
    <section id="conteudoSonoDicasVideo">
        <div class="videoSonoDicas">
            <video width="700" height="500" controls>
                <source src="../img/12dicas.mp4" type="video/mp4">
                <source src="movie.ogg" type="video/ogg">
            </video>
        </div>

        <div class="textoSonoDicas">
            <h1>12 dicas para dormir melhor • Psicologia • Casule Saúde e Bem-estar</h1>
            <p>Como é o seu sono? Você tem um sono reparador? Assista ao vídeo para saber algumas dicas
                 de como dormir melhor. 
            </p>
        
            <div class="icones-video">
                <div class="btn-youtube">
                    <a href="https://youtu.be/a7gI6WIWCF8?si=Fo5u_4E32iYG-wM1" target="_blank">Assista no youtube</a>
                </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoSonoDicas">
                <h1 class="title-SonoDicas">
                <?php  echo $listagem->nome_sonodicas;?>
                </h1>
                <p>
                <?php  echo $listagem->sonodicas;?>
                </p>
                </section>
                <?php
                }
