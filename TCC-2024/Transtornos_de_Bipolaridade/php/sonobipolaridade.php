...
$registro = $respositorioConteudo->listarTodosSonobipolaridadecomum();
?>
...
<body>
    ...
    <section id="conteudoSonoBipolaridadeVideo">
        <div class="videoSonoBipolaridade">
            <video width="700" height="500" controls>
                <source src="../img/A IMPORTÂNCIA DO SONO PARA O BIPOLAR.mp4" type="video/mp4">
                <source src="movie.ogg" type="video/ogg">
            </video>
        </div>

        <div class="textoSonoBipolaridade">
            <h1>A IMPORTÂNCIA DO SONO PARA O BIPOLAR</h1>
            <p>👉🏼 PSICÓLOGO, participe da ÚLTIMA Semana Transtorno de Humor dias 22, 23 e 24 de janeiro, às 20h. 
                Três aulas gratuitas para você aprofundar seu conhecimento sobre transtornos
                 de humor e se tornar a referência que os pacientes procuram.
            </p>
        
            <div class="icones-video">
                <div class="btn-youtube">
                    <a href="https://youtu.be/5vmi0kAbfEI?si=v2d1CTMcTtBCVKN8" target="_blank">Assista no youtube</a>
                </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoSonoBipolaridade">
                <h1 class="title-SonoBipolaridade">
                <?php  echo $listagem->nome_sonobipolaridade;?>
                </h1>
                <p>
                <?php  echo $listagem->sonobipolaridade;?>
                </p>
                </section>
                <?php
                }
