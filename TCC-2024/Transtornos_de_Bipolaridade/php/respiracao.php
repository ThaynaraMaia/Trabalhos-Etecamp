...
$registro = $respositorioConteudo->listarTodosRespiracaocomum();
?>
...
<head>
    ...
    <title>Equilibrio - Respiração </title>
...
<body>
    ...
    <header>
        ...
        <section id="conteudoRespiracaoVideo">
        <div class="videoRespiracao">
            <video width="700" height="500" controls>
                <source src="../img/Respiração Relaxante.mp4" type="video/mp4">
                <source src="movie.ogg" type="video/ogg">
            </video>
        </div>

        <div class="textoRespiracao">
            <h1>Respiração Relaxante</h1>
            <p>Essa é uma técnica de respiração que tem sido identificada como um tranquilizante natural no sistema nervoso. 
                Para fazer, inspire por 4 segundos, segure por 7 segundos e depois expire por 8 segundos e repita o processo. 
                Você pode usar essa técnica quando estiver se sentindo sobrecarregado, estressado, 
                ansioso ou mesmo antes de dormir para se acalmar.</p>
            

            <div class="icones-video">
                <div class="btn-youtube">
                    <a href="https://youtu.be/2w-FNiySmKk?si=zSMHQIQa_LLMxTxw" target="_blank">Assista no youtube</a>
                </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoRespiracao">
                <h1 class="title-Respiracao">
                <?php  echo $listagem->nome_respiracao;?>
                </h1>
                <p>
                <?php  echo $listagem->respiracao;?>
                </p>
                </section>
                <?php
                }
