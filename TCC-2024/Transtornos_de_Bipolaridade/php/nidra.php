...
$registro = $respositorioConteudo->listarTodosNidracomum();
?>
...
<body>
    ...
    <header>
        ...
        <section id="conteudoNidraVideo">
        <div class="videoNidra">
            <video width="700" height="500" controls>
                <source src="../img/Yoga Nidra_ RELAXAMENTO PROFUNDO consciente _ Meditação - Fernanda Yoga.mp4" type="video/mp4">
            <source src="movie.ogg" type="video/ogg">
            </video>
        </div>

        <div class="textoNidra">
            <h1>Yoga Nidra: RELAXAMENTO PROFUNDO consciente | Meditação - Fernanda Yoga</h1>
            <p>O Yoga Nidra é o sono profundo consciente. É o estágio entre estar acordado e 
                dormindo que relaxa tensões emocionais, mentais e físicas, dissolve padrões mentais, 
                comportamentais e emocionais inconscientes, reduz a ansiedade, previne doenças, ajuda no aprendizado, 
                revigora o corpo e a mente e pode ser utilizada como uma prática terapêutica.</p>
            

            <div class="icones-video">
                <div class="btn-youtube">
                    <a href="https://youtu.be/ImKY91SPh7E?si=tdxrgHWxqeSP81to" target="_blank">Assista no youtube</a>
                </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoNidra">
                <h1 class="title-Nidra">
                <?php  echo $listagem->nome_nidra;?>
                </h1>
                <p>
                <?php  echo $listagem->nidra;?>
                </p>
                </section>
                <?php
                }
