...
$registro = $respositorioConteudo->listarTodosPranayamacomum();
?>
...
<body>
    ...
    <section id="conteudoPranayamaVideo">
    <div class="videoPranayama">
        <video width="700" height="500" controls>
            <source src="../img/Raja Pranayama - Exercícios de Respiração Completa para sua saúde na yoga..mp4" type="video/mp4">
            <source src="movie.ogg" type="video/ogg">
        </video>
    </div>
    
    <div class="textoPranayama">
        <h1>Raja Pranayama - Exercícios de Respiração Completa para sua saúde na yoga</h1>
        <p>Olá! Meu nome é Mariana Keller, sou professora de Hatha Yoga desde 2001. Sou iniciada também em Kriya 
            Yoga e princípios do Ayurveda, este último em retiro na Índia com David Frawley e Shambhavi Chopra, 
            certificado pelo American Institute of Vedic Studies.
        </p>

        <div class="icones-video">
            <div class="btn-youtube">
                <a href="https://youtu.be/W89SksoLRCo?si=NT4saebayhPbDvCV" target="_blank">Assista no youtube</a>
            </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoPranayama">
                <h1 class="title-pranayama">
                <?php  echo $listagem->nome_pranayama;?>
                </h1>
                <p>
                <?php  echo $listagem->pranayama;?>
                </p>
                </section>
                <?php
                }
