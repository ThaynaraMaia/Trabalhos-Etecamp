...
$registro = $respositorioConteudo->listarTodosAsanascomum();
?>
...
<body>
    ...
    <section id="conteudoAsanasVideo">
        <div class="videoAsanas">
            <video width="700" height="500" controls>
                <source src="../img/Yoga rápida para MELHORAR Postura_ REDUZIR e PREVENIR Má postura.mp4" type="video/mp4">
                <source src="movie.ogg" type="video/ogg">
            </video>
        </div>

        <div class="textoAsanas">
            <h1>Yoga rápida para MELHORAR Postura: REDUZIR e PREVENIR Má postura</h1>
            <p>A aula de hoje é ideal para quem busca melhorar e corrigir a postura de forma rápida e prática.
                Aula perfeita para fazer em qualquer momento do seu dia e podendo repetir diariamente por 7 dias
                 para melhores resultados. Para aproveitar ainda mais os benefícios, pode fazer diariamente e
                 sempre que quiser! A má postura pode causar muitas dores nas costas e pescoço e por isso é
                  muito importante fortalecer as costas, melhorar a mobilidade da coluna, abrir o peito e melhorar
                   o alongamento da lateral. </p>


            <div class="icones-video">
                <div class="btn-youtube">
                    <a href="https://youtu.be/7PQ2IHTQ7Wg?si=o-iZLxfeDfLj9Qtr" target="_blank">Assista no youtube</a>
                </div>
        ...
        while ($listagem = $registro->fetch_object()){
            ?>
                <section id="conteudoAsanas">
                <h1 class="title-asanas">
                <?php  echo $listagem->nome_asanas;?>
                </h1>
                <p>
                <?php  echo $listagem->asanas;?>
                </p>
                </section>
                <?php
                }
