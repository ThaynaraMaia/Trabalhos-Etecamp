...
<body>
    ...
    <div class="page-content">
        ...
        <h1 id="inicio" style="width: 100%; max-width: 1200px;"> Vídeos Curtos para a sua aprendizagem! </h1>

        <p id="texto_in"> Clique no tópico que você tem interesse para estudar hoje. </p>
        ...
        <div class="cards-container">
            ...
            <a href="./tartaruga.php?Categoria=Tartaruga">

                <div class="card">
                    <img src="./img/tartaruga-marinha.png" alt="tartaruga-marinha" style="width: 90px; height:90px;">
                    <h3>Tartaruga</h3>
                </div>

            </a>

            <a href="./tubarao.php?Categoria=Tubarão">

                <div class="card">
                    <img src="./img/tubarao-martelo.png" alt="tubarão-martelo" style="width: 90px; height:90px;">
                    <h3>Tubarão</h3>
                </div>

            </a>

            <a href="./baleia.php?Categoria=Baleia">

                <div class="card">
                    <img src="./img/baleia.png" alt="baleia" style="width: 90px; height:90px;">
                    <h3>Baleia</h3>
                </div>

            </a>

            <a href="./arraia.php?Categoria=Arraia">

                <div class="card">
                    <img src="./img/arraia.png" alt="arraia" style="width: 90px; height:90px;">
                    <h3>Arraia</h3>
                </div>

            </a>

            <a href="./golfinho.php?Categoria=Golfinho">

                <div class="card">
                    <img src="./img/golfinho.png" alt="golfinho" style="width: 90px; height:90px;">
                    <h3>Golfinho</h3>
                </div>

            </a>

            <a href="./aguaViva.php?Categoria=Água-Viva">

                <div class="card">
                    <img src="./img/agua-viva.png" alt="água-viva" style="width: 90px; height:90px;">
                    <h3>Água-Viva</h3>
                </div>

            </a>

            <a href="./polvo.php?Categoria=Polvo">

                <div class="card">
                    <img src="./img/polvo.png" alt="polvo" style="width: 90px; height:90px;">
                    <h3>Polvo</h3>
                </div>

            </a>

            <a href="./moreia.php?Categoria=Moreia">

                <div class="card">
                    <img src="./img/moreia.png" alt="Moreia" style="width: 90px; height:90px;">
                    <h3>Moreia</h3>
                </div>
