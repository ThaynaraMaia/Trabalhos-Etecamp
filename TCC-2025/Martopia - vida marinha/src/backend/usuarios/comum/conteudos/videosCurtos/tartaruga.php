...
$videos = $respositorioConteudo->listarporCategoria($categoria);
...
<head>
    ...
    <title>Tartaruga Vídeos Curtos - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/tartaruga-marinhaM.png" alt="tartaruga-marinha" width="200px; height:200px;">

            <div class="centraliza">

                <h2>Tartaruga - Vídeos Curtos</h2>
        ...
        <div class="cards-container">
            ...
            if (empty($videos)) {
            ?>
                <h2>Nenhum video colocado pelo Biólogo</h2>
                <?php
            } else {
                foreach ($videos as $posicao => $linha):  ?>
                    <iframe class="card" width="600" height="315" src="<?php echo $linha['link'] ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <?php endforeach;
            } ?>
