...
<head>
    ...
    <title>Tubarão Vídeos Curtos- Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/tubarao-marteloM.png" alt="tubarão-martelo" width="200px; height:200px;">


            <div class="centraliza">

                <h2>Tubarão - Vídeos Curtos</h2>
