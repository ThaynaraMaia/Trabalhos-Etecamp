...
<head>
    ...
    <title>Golfinho Vídeos Curtos - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/golfinhoM.png" alt="golfinho" width="200px; height:200px;">

            <div class="centraliza">

                <h2>Golfinho - Vídeos Curtos</h2>
        ...
        <div class="cards-container">
            ...
            if (empty($videos)) {
            ?>
                <h2>Nenhum video colocado pelo Biologo</h2>
                <?php
            } else {
