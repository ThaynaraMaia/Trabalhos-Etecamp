...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/documentarioM.png" alt="cursoIconIcon">

            <div class="centraliza">

                <h2>Documentários - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <!-- <div class="card">
                ...
                <div class="img-text">
                    ...
                    <img src="./img/maxresdefault.jpg" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain; border-radius:20px;">
                    <h2>"Mestres do Oceano – Os Animais Mais Fascinantes das Profundezas"</h2>

                </div>

                <div class="card-buttons">

                    <button> <a href="https://youtu.be/h-enFqXm0zI?si=J16iQ7FDCsGeMMfN">Assistir Documentário</a> </button>
