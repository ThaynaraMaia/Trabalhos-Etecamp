...
<body>
    ...
    <div class="page-content">
      ...
      <div class="iconeCentral">
            ...
            <img id="inicio" src="./img//cursoM.png" alt="cursoIconIcon" >


            <div class="centraliza">

                <h2>Cursos - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <!-- <div class="card">
                ...
                <div class="img-text">
                    ...
                    <img src="./img/sao_judas.jpg" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain; border-radius:20px;">
                    <h2>"Bacharelado: Universidade São Judas Tadeu (USJT)"</h2>

                </div>

                <div class="card-buttons">

                    <button> <a href="https://www.guiadacarreira.com.br/cursos-e-faculdades/sao-paulo--sao-paulo/ciencias-biologicas?utm_source=chatgpt.com">Veja mais</a> </button>
            ...
            <?php foreach ($listarpotipo as $posicao => $linha):  ?>
                <div class="card">
                    ...
                    <div class="img-text">
                        ...
                        <img src="../../../../../frontend/public/img_conteudos/<?php echo $linha['caminho_img'] ? $linha['caminho_img'] : "educacao.png" ?>" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain;">
