...
<head>
    ...
    <title>Artigos - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/artigosM.png" alt="artigoIcon">

            <div class="centraliza">

                <h2>Artigos - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <?php foreach ($listarpotipo as $posicao => $linha): ?>
                <div class="card">
                    <div class="img-text">
                        <img src="../../../../../frontend/public/img_conteudos/<?php echo htmlspecialchars($linha['caminho_img']) ? $linha['caminho_img'] :  "artigo.png" ?>"
                            alt="artigoIcon"
                    ...
                    <div class="card-buttons">
                        ...
                        <?php if ($jaLido): ?>
                            ...
                            <button class="btn-ler" data-id-conteudo="<?php echo htmlspecialchars($linha['id']) ?>;" data-tipo="educacao">
                                ...
                                <a href="<?php echo htmlspecialchars($linha['link']); ?>" style="font-size: 1.2rem;"
                                    target="_blank"
                                    style="color: white; text-decoration: none;">
                                    Ler Artigo Novamente
                                </a>
                            </button> <br> <br>
                            <button class="btn-lido" disabled style="font-size: 1.2rem; background-color: #28a745; color: white; cursor: not-allowed;">
                                ✓ Artigo Lido
                            </button> <br> <br>
                        <?php else: ?>
                            ...
                            <button class="btn-lido"
                                ...
                                disabled
                                style="background-color: #38a0dd; color: #ccc; cursor: not-allowed;font-size: 1.2rem;">
                                Leia o artigo primeiro
                            </button>
                        <?php endif; ?>
                    </div>
                </div>
