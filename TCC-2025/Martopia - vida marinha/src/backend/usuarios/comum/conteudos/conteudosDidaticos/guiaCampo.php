...
<head>
    ...
    <title>Guia de Campo - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/guiaCampoM.png" alt="cursoIconIcon">


                <div class="centraliza">

                    <h2>Guias de Campo - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <!-- <div class="card">
                ...
                <div class="img-text">
                    ...
                    <img src="./img/unnamed.jpg" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain; border-radius:20px;">
                    <h2>"Peixes recifais: aquarelas vivas"</h2>

                </div>

                <div class="card-buttons">

                    <button> <a href="http://cebimar.usp.br/images/cebimar/servicos-e-produtos/edicoes/Folheto-Peixes-Recifais-CEBIMarUSP.pdf"> Ver Guia de Campo </a> </button>
            ...
            <?php foreach ($listarpotipo as $posicao => $linha):  ?>
                <div class="card">
                    ...
                    <div class="img-text">
                        ...
                        <img src="../../../../../frontend/public/img_conteudos/<?php echo $linha['caminho_img'] ? $linha['caminho_img'] : "guia_usuario.png" ?>" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain;">
                    ...
                    <div class="card-buttons">
                        ...
                        <?php else: ?>
                            <!-- Botões normais para artigos não lidos -->
                            <button class="btn-ler" data-id-conteudo="<?php echo htmlspecialchars($linha['id']); ?>" data-tipo="educacao">
                                <a href="<?php echo htmlspecialchars($linha['link']); ?>"
                                    target="_blank"
                                    style="color: white; text-decoration: none;  font-size: 1.2rem">
