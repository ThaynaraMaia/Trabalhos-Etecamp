...
<head>
    ...
    <title>Filmes - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/filmeM.png" alt="cursoIconIcon">


            <div class="centraliza">

                <h2>Filmes - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <!-- <div class="card">
                ...
                <div class="img-text">
                    ...
                    <img src="./img/compose.webp" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain; border-radius:20px;">
                ...
                <div class="card-buttons">
                    ...
                    <button> <a href="https://www.disneyplus.com/movies/procurando-nemo/1p8Wm5K1ExLX"> Onde Assistir </a> </button>
            ...
            <?php foreach ($listarpotipo as $posicao => $linha):  ?>
                <div class="card">
                    ...
                    <div class="img-text">
                        ...
                        <img src="../../../../../frontend/public/img_conteudos/<?php echo $linha['caminho_img'] ?>" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain;">
                        <h2><?php echo $linha['titulo'];  ?></h2>

                    </div>
                    <div class="card-buttons">
                        <button class="btn-ler" data-id-conteudo="<?php echo htmlspecialchars($linha['id']); ?>">
                            <a href="<?php echo $linha['link'] ?>" target="_blank" style="font-size: 1.2rem;">Onde Assitir</a>
                        </button> <br> <br> 
                        ...
                        <!-- <?php if ($jaLido): ?>
                            ...
                            <button class="btn-ler"   data-id-conteudo="<?php echo htmlspecialchars($linha['id']) ?>;" data-tipo="educacao">
                                <a href="<?php echo htmlspecialchars($linha['link']); ?>"
                                    ...
                                    Ler Artigo Novamente
                                </a>
                            </button>
                            <button class="btn-lido" disabled style="background-color: #28a745; color: white; cursor: not-allowed;">
                                ✓ Artigo Lido
                            </button>
                        <?php else: ?>
                            ...
                            <button class="btn-lido"
                                ...
                                disabled
                                style="background-color: #b0c4de; color: #666; cursor: not-allowed;">
                                Veja primeiro
                            </button>
                        <?php endif; ?> -->
