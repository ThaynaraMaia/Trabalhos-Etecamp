...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/livroM.png" alt="livroIcon">
            <div class="centraliza">

                <h2>Livros - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <!-- Cards dinâmicos dos conteúdos do banco -->
            <?php foreach ($listarpotipo as $posicao => $linha): ?>
                <div class="card">
                    <div class="img-text">
                        <img src="../../../../../frontend/public/img_conteudos/<?php echo htmlspecialchars($linha['caminho_img']) ? $linha['caminho_img'] :  "livro.png" ?>"
                            alt="conteudoIcon"
    ...
    <!-- Incluindo o mesmo JavaScript da funcionalidade de leitura -->
