...
<head>
    ...
    <title>Podcast - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="./img/podcastM.png" alt="cursoIconIcon">

            <div class="centraliza">

                <h2>Podcasts - Vida Marinha</h2>
        ...
        <div class="cards-container">
            ...
            <!-- <div class="card">
                ...
                <div class="img-text">
                    ...
                    <img src="./img/channels4_banner.jpg" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain; border-radius:20px;">
                    <h2>"Direta sem Café – Episódio 38: Poluição nos Oceanos e Proteção da Vida Marinha"</h2>

                </div>

                <div class="card-buttons">

                    <button> <a href="https://youtu.be/gr5KPicyEmk?si=d-NZCkXksmzqL1XJ"> Assistir Podcast </a> </button>
            ...
            <?php foreach ($listarpotipo as $posicao => $linha):  ?>
                <div class="card">
                    ...
                    <div class="img-text">
                        ...
                        <img src="../../../../../frontend/public/img_conteudos/<?php echo $linha['caminho_img'] ? $linha['caminho_img'] : "podcast.png"; ?>" alt="artigoIcon" style="width: 150px; height:120px; object-fit:contain;">
