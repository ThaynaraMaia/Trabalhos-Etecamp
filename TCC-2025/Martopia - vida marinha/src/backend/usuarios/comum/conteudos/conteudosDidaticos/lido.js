document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".card").forEach(card => {
        ...
        if (jaLidoNoServidor) {
            ...
            btnLer.style.backgroundColor = "#045a9";
            btnLer.style.color = "#fff";
            btnLer.style.cursor = "not-allowed";
            btnLer.innerHTML = "Conteúdo Já Acessado";
            return;
        }
        ...
        if (!conteudosLiberados.has(idConteudo)) {
            ...
            btnLido.innerText = "Acesse o conteúdo primeiro";
            btnLido.style.backgroundColor = "#045a9";
            btnLido.style.color = "#fff";
            ...
            fetch("marcar_lido.php", {
                ...
                .then(data => {
                    if (data.status === "sucesso") {
                        btnLido.innerText = "✓ Conteúdo Acessado";
                        btnLido.disabled = true;
