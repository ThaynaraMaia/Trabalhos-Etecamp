...
$Conscientizacao = $respositorioConteudo->listarConscientizacaoportipo($tipo, $categoria)
...
<head>
    ...
    <title>Notícias - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="../IMG/noticiaM.png" alt="noticiaIconIcon">
        ...
        <div class="cards-container">
            ...
            <?php
            if (empty($Conscientizacao)) {
            ?>
                <h2>Nenhuma Notícia postada pelo Biólogo</h2>
                <?php
            } else {
                foreach ($Conscientizacao as $posicao => $linha):
                    // ✅ CORRIGIDO: Verificar se já foi lido usando o método correto
                    $jaLido = false;
                    if ($id) {
                        // Use o método específico para conscientização
                        $jaLido = $respositorioConteudo->artigoJaLidoConst($id, $linha['id']);
                    }
                ?>
                    <div class="card">
                        <div class="img-text">
                        ...
                        <div class="card-buttons">
                            <?php if ($jaLido): ?>
                                <!-- ✅ Se já foi lido -->
                                <button class="btn-ler"
                                    data-id-conteudo="<?php echo htmlspecialchars($linha['id']); ?>"
                                    data-tipo="conscientizacao">
                                    <a href="<?php echo htmlspecialchars($linha['link']); ?>"
                                        target="_blank"
                                        style="color: white; text-decoration: none; font-size:1.2rem;">
                                        Ler Notícia Novamente
                                    </a>
                                </button> <br> <br>
                                <button class="btn-lido"
                                    disabled
                                    style="background-color: #28a745; color: white; cursor: not-allowed;font-size:1.2rem;">
                                    ✓ Notícia Lida
                                </button> <br> <br>
                            <?php else: ?>
                                <!-- ✅ CORRIGIDO: Botões normais com atributos corretos -->
                                <button class="btn-ler"
                                    data-id-conteudo="<?php echo htmlspecialchars($linha['id']); ?>"
                                    data-tipo="conscientizacao">
                                    <a href="<?php echo htmlspecialchars($linha['link']); ?>"
