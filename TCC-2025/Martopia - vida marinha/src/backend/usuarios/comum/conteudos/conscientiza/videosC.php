...
$videos = $respositorioConteudo->listarConscientizacaoportipo($tipo, $categoria);
...
<head>
    ...
    <title>Vídeos Curtos - Projeto Martopia</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <div class="iconeCentral">
            ...
            <img id="inicio" src="../IMG/videoM.png" alt="videosIcon">

            <div class="centraliza">

                <h2>Vídeos - Conscientização</h2>
