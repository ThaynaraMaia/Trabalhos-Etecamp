...
// Buscar todas as palavras MÉDIAS
$sql = "SELECT id, palavra FROM termo WHERE dificuldade = 2 ORDER BY id ASC";
...
<body>
    ...
    <script src="./termoJs/medio.js"></script>
</body>
