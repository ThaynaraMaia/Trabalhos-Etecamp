...
// Buscar todas as palavras difíceis (7 letras)
$sql = "SELECT id, palavra FROM termo WHERE dificuldade = 3 ORDER BY id ASC";
...
<head>
    ...
    <title>Jogo do Termo - Difícil</title>
...
<body>
    ...
    <script src="./termoJs/dificil.js"></script>
</body>
