...
*/
    ...
    <div class="page-content">
        ...
        <p id="texto_in" style="padding-top: 5%;">Um espaço de interação, conhecimento e criatividade para o seu dia a dia com o oceano!</p>
        ...
        <div class="perfil_card">
            ...
            <div class="perfil-user">
                ...
                <div class="perfil-btn">
                    <h2 style="font-family: 'Texto'; font-weight: bold;"> <?php echo $_SESSION['nome']; ?> </h2>
                    <br> <br>

                    <div style="display: flex;">

                        <a href="./meus_cont.php" class="botao" style="background: #e18451; font-size: 1.4rem;"> Minhas Postagens </a>
                        <a href="./notifica.php" class="botao" style="background: #e18451;margin-left:2rem; font-size: 1.4rem;"> Notificações </a>
                    ...
                    <div class="post-header">
                        ...
                        <div class="user-info">
                            <div class="user-name" style="font-size: 1.2rem;">
                                <?php echo $linhas->autor; ?>
                                <?php if ($linhas->tipo_usuario == 1): ?>
                                    <span style="color: #38a0dd; font-size: 0.9em;"> (Biólogo)</span>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="pontos">
                            ...
                            <div class="menu-dropdown">
                                ...
                                <a href="#" onclick="denunciarPost(<?php echo $linhas->id; ?>)" style="font-size: 1.1rem; font-family: 'Texto';">🚩 Denunciar</a>
                            </div>
                        </div>
                    </div>
            ...
            ?>
                <div class="post-card 2" aria-label="Postagem de texto do usuário">
                    ...
                    <div class="post-actions">
                        ...
                        <button class="action-btn btn-comentar" onclick="abrirModal(<?php echo $linhas->id; ?>)" style="color:#045a94;">
                            <i class="bi bi-chat"></i>
                            <span style="font-size: 1.1rem; font-family: 'Texto';">Comentar</span>
                        </button>
                                    ...
                                    <div class="novo-comentario" style="border-top: 1px solid #ddd; padding: 10px; background: #fff; margin-top:6rem;">
                                        <div class="comentario-input-container" style="display: flex; align-items: center; gap: 10px;">
                                            ...
                                            <div class="comentario-input-wrapper" style="flex: 1; display: flex; align-items: center; gap: 8px;">
                                                ...
                                                <input type="text" id="texto-comentario" placeholder="Escreva seu comentário..." style="flex: 1; padding: 8px; border-radius: 8px; border: 1px solid #ccc; font-size: 1.2rem; font-family: 'Texto';">
    ...
    <div class="modal" id="camera-modal">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <br> <br>
                <h2 style="color: #045a94; font-family:'Texto'; ">Postagem de Fotos</h2>
            </div>
            ...
            <form action="novoPost.php" method="POST" enctype="multipart/form-data">
                ...
                <button class="submit-btn" type="submit" id="publicar">
                    Publicar Foto
                </button>
    ...
    <div class="modal" id="text-modal">
        ...
        <div class="modal-content">
            ...
            <form action="novoText.php" method="POST" enctype="multipart/form-data">
                ...
                <button class="submit-btn" id="publicarT">
                    Publicar Texto
                </button>
                ...
                <div class="novo-comentario">
                    <div class="comentario-input-container">
                        ...
                        <div class="comentario-input-wrapper" style="margin-top: 15px; display:inline; bottom:0;">
                            ...
                            <input type="text" id="texto-comentario" placeholder="Escreva seu comentário..." style="width: 80%; padding: 8px; border-radius: 8px; border: 1px solid #ccc; display:inline; font-size: 1.2rem; font-family: 'Texto';">
