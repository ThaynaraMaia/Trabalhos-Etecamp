    ...
    <div class="page-content">
        ...
        <div class="perfil_card">
            ...
            <div class="perfil-user">
                ...
                <img src="../../../../<?php echo htmlspecialchars($foto); ?>" alt="Imagem de Peril" id="img-perfil" style="margin-left: -3rem;">

                <div class="perfil-btn">
                    <h2 style="font-family: 'Texto'; font-weight: bold; margin-left: -2rem;"> <?php echo $_SESSION['nome']; ?> </h2>
                    <br>
                    <a href="insta.php" class="botao" style="background: #e18451; font-size: 1.4rem; font-family: 'Texto'; margin-left: 20px;"> Voltar </a>
                </div>
                    ...
                    <div class="post-header">
                        ...
                        <div class="pontos">
                            ...
                            <div class="menu-dropdown">
                                <a href="excluirmeuPost.php?excluir=<?php echo $linhas->id; ?>" onclick="return confirm('Tem certeza que deseja excluir este post?')" style="font-size: 1.1rem; font-family: 'Texto';">❌ Excluir</a>
                            </div>
                        </div>
                    </div>
