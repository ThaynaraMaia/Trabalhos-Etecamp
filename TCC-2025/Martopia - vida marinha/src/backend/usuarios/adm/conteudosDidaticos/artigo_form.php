...
<body>
  ...
  <div class="iconeCentral">
    ...
    <div> <i class="bi bi-journal-bookmark" style="color: #000; font-size: 7rem;"></i> </div>

    <div class="centraliza">

      <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, .3); color: #fff;">Adicionar Conteúdos Didáticos</h2>
  ...
  <div class="page-content">
    ...
    <form class="form" action="salvar_conteudo.php" method="POST" enctype="multipart/form-data">
      ...
      <h2 style="font-size: 2rem;">Cadastrar Conteúdos</h2>
      ...
      <input type="text" name="tipo" value="Educação" readonly style="font-size: 1.2rem;">
      ...
      <select name="categoria" id="categoria" required style="font-size: 1.2rem;;">
        ...
        <option value="Artigos" style="font-size: 1.2rem;;">Artigos</option>
        <option value="Livros" style="font-size: 1.2rem;;">Livros</option>
        <option value="Documentarios" style="font-size: 1.2rem;;">Documentários</option>
        <option value="Filmes" style="font-size: 1.2rem;;">Filmes</option>
        <option value="Podcasts" style="font-size: 1.2rem;;">Podcasts</option>
        <option value="Guias de Campo" style="font-size: 1.2rem;;">Guias de Campo</option>
        <option value="Cursos" style="font-size: 1.2rem;;">Cursos</option>
        <option value="Projetos para Conhecer" style="font-size: 1.2rem;;">Projetos para Conhecer</option>
      </select>
      ...
      <div class="preview-container" id="preview-container">
        <p class="text-sm font-semibold mb-2" style="font-size: 1.2rem;">Pré-visualização:</p>
      ...
      <input class="input" type="text" name="link" style="font-size: 1.2rem; font-family: 'Texto';">
