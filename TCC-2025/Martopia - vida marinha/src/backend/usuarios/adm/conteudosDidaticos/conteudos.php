...
<body>
    ...
    <div class="iconeCentral">
        ...
        <div> <i class="bi bi-file-earmark-richtext" style="color: #000; font-size: 7rem;"></i> </div>

        <div class="centraliza">

            <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, .3);">Gerenciamento de Conteúdos Educativos</h2>
    ...
    <div class="page-content" style="margin-top: 5rem;">
        ...
        <div class="cards-container">
            ...
            <a href="./conscientiza.php">

                <div class="card">
                    <img src="../img/planeta-terra.png" alt="IconConscientizar"> <br>
