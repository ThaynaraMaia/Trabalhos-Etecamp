...
<body>
    ...
    <div class="iconeCentral">
        ...
        <div> <i class="bi bi-exclamation-triangle" style="color: #000; font-size: 7rem;"></i> </div>

        <div class="centraliza">

            <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, .3); color: #fff;">Gerenciar Denúncias - InstaMar</h2>
    ...
    <div class="page-content" style="margin-top: 5rem;">
        ...
        <div class="cards-container">
            ...
            <a href="./denuncias.php">
                ...
                <div class="card">
                    <img src="../img/post.png" alt="Memoria" style="width: 70px; height: 70px">
                    <br>
                    <h3>Posts</h3>
                </div>
            ...
            <a href="./denunciaComent.php">

                <div class="card">
                    <img src="../img/comentario.png" alt="Memoria" style="width: 70px; height: 70px">
                    <br>
                    <h3>Comentários</h3>
                </div>
        ...
        <!-- <a href="./meusConteudos.php" id="span" style="text-decoration:none;">

            <div class="card">
                <img src="../img/administrador.png" alt="adminIcon" style="width: 90px; height: 90px;">
