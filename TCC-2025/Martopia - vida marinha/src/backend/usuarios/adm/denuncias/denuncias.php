...
$contDenuncias = $respositorioInstamar->contarTodasDenuncias();
...
<body>
    ...
    <div class="iconeCentral">
        ...
        <div> <img src="../img/post.png" alt="postDenunciaIcon" width="100px" height="100px"> </div>

        <div class="centraliza">

            <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, .3); color: #fff;">Denúncias - Postagens</h2>
    ...
    <div class="page-content" style="margin-top: 10rem;">
        ...
        <div class="card">
            <form method="GET" action="denuncias.php" style="margin-bottom: 20px; text-align:center;">
                <label for="pesquisa_id" style=" font-weight: bold;">Pesquisar por ID do post denunciado:</label>
            ...
            if (isset($_GET['pesquisa_id'])) {
                ...
                $resultado = $respositorioInstamar->buscarPostagemDenunciadaPorId($id_pesquisa);
            ...
            ?>
                            <div class="post-card">
                                <div class="post-header">
                                    <div class="user-avatar" style="width: 60px; height: 60px;">
                                        <img src="../../../../<?php echo $linhas->foto_usuario ?: 'frontend/public/img/fotoperfil.png'; ?>" alt="Imagem de Perfil" id="img-perfil">
                                    </div>
                                    <div class="user-info">
                                ...
                                <img src="../../../../frontend/public/img_instamar/<?php echo $linhas->imagem_post; ?>" alt="Imagem do Post" class="post-image">
                                ...
                                <div class="post-caption" style="font-size: 1.1rem; font-family: 'Texto';">
                        ...
                        ?>
                            <div class="post-card 2">
                                <div class="post-header">
                                    <div class="user-avatar" style="width: 60px; height: 60px;">
                                        <img src="../../../../<?php echo $linhas->foto_usuario ?: 'frontend/public/img/fotoperfil.png'; ?>" alt="Foto de perfil do Usuário" />
                                    </div>
                                    <div class="user-info">
                                        <div class="user-name" style="font-size: 1.2rem;"><?php echo $linhas->autor; ?></div>
                                        <time class="post-date" style="font-size: 1rem;"><?php echo $linhas->data_postagem; ?></time>
                                    </div>

                                </div>

                                <div class="post-text collapsed" id="post-text" style="font-size: 1.1rem; font-family: 'Texto';">
                                    <p><?php echo $linhas->legenda; ?></p>
                                </div>
            ...
            <?php
                    ...
                    echo "<p style='color:red; text-align:center; font-size:18px;'>Nenhuma postagem encontrada com esse ID.</p>";
                }
            }
            ?>
            ...
            <div class="tabela-scroll">
                ...
                <table class="tabela" aria-describedby="totalDenunciasCard">
                    <thead class="nametable">
                        <tr style="font-size: 1.3rem; font-family: 'Texto';">
                    ...
                    <tbody id="denunciasTableBody">
                        <?php
                        while ($linhas = $listarDenuncias->fetch_object()) {
                        ?>
                            <tr style="font-size: 1.2rem; font-family: 'Texto';">
                                ...
                                <td class="info" data-label="Tipo" style="padding-left: 70px;"><?php echo $linhas->id_post; ?> </td>
                                <td data-label="Excluir">
                                    <div class="btns">


                                        <a href="excluirPost.php?excluir=<?php echo $linhas->id_post; ?>"
                                            class="btn-excluir disabled"
                                            style="font-size: 1.2rem; border-radius: 20px; color: #fff;"
                                            data-id="<?php echo $linhas->id_post; ?>"
                                            title="Excluir postagem">
                                            <i class="bi bi-x-circle-fill"></i> Excluir
                                        </a>


                                        <button class="btn-notificar" data-id="<?php echo $linhas->id_post; ?>" title="Notificar usuário" style="font-size: 1.2rem; border-radius: 20px; background:#38a0dd; color: #fff;">
