...
<body>
    ...
    <div class="iconeCentral">
         ...
         <div> <img src="../../img/termo.png" alt="addQuestionIcon" style="color: #000; "></i> </div>

        <div class="centraliza">

            <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, .3); color: #fff;">Adicionar Palavras - TerMar</h2>
    ...
    <div class="page-content">
        ...
        <form class="form" action="salvar.php" method="POST" enctype="multipart/form-data">

            <h2 style="font-size: 2rem;"> Adicionar Palavras ao TerMar</h2>
            ...
            <!-- <label>Dica:</label>
            <textarea name="dica" required></textarea> -->

            <div class="btn"> <button type="submit" style="font-size: 1.2rem; font-family: 'Texto';">Salvar Palavra</button> </div>
