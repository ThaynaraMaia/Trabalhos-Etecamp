...
<body>
    ...
    <div class="iconeCentral">
        ...
        <div> <i class="bi bi-controller" style="color: #000; font-size: 7rem;"></i> </div>

        <div class="centraliza">

            <h2 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, .3); color: #fff;">Gerenciamento dos Jogos</h2>
