...
<head>
    ...
    <title>Deficiência Visual - Gato</title>
    <style>
        #areaSugestoes {
...
<body>
    ...
    <a href="https://www.youtube.com/"><img src="../../img/dvgv.png" alt="" style="width: 500px; height: 300px; display: flex; flex-direction: column; align-items: center; margin-top: 50px;"></a>
    </div>
        ...
        <div class="links">
            <div class="row">
                ...
                <div class="col-8">
                    <div class="btnTipo">
                        <div>
                            <a href="../deficiencias/defvisc.php" class="card">
        ...
        <div class="introducao">
            <div class="row">
                <div class="col-2"></div>
                <div class="col-8">
                    <p style="text-align: justify;">A deficiência visual em gatos pode ocorrer devido a doenças oculares congênitas, traumas, infecções, glaucoma, catarata ou degenerações relacionadas à idade. Os felinos demonstram uma adaptação ainda mais impressionante que os cães, utilizando seus bigodes altamente sensíveis, audição apurada e memória espacial para navegar com precisão. Gatos cegos frequentemente surpreendem seus tutores com a naturalidade com que se adaptam, mantendo comportamentos típicos como brincar, caçar e explorar o ambiente.
                    </p>
                </div>
                <div class="col-2"></div>
            </div>
        ...
        <div class="cuidadosBasicos" style="margin-top: 80px;">
            ...
            $dados = [
                ['id' => 1, 'sugestao' => '01. Preservação do ambiente conhecido: Gatinhos cegos memorizam o ambiente e dependem dessa familiaridade para se mover com segurança. Por isso, é importante evitar mudar móveis, arranhadores ou comedouros de lugar, mantendo a rotina estável.', 'img_front' => '../img/flipcards/dvg1.png', 'img_back' => '../img/flipcards/dvg2.png'],

                ['id' => 2, 'sugestao' => '02. Enriquecimento sensorial: Brinquedos com sons, cheiros e texturas estimulam os sentidos e ajudam o gato a se manter ativo. Esses estímulos substituem a falta de visão e proporcionam bem-estar físico e mental.', 'img_front' => '../img/flipcards/dvg3.png', 'img_back' => '../img/flipcards/dvg4.png'],

                ['id' => 3, 'sugestao' => '03. Monitoramento de comportamento: Fique atento a sinais de estresse, medo ou desorientação. Gatos com deficiência visual podem demorar mais para se adaptar a mudanças e precisam de tempo e paciência para se sentir seguros.', 'img_front' => '../img/flipcards/dvg5.png', 'img_back' => '../img/flipcards/dvg6.png'],
            ];
            ?>
            ...
            <div class="nutricao" style="margin-top: 80px;">
                ...
                // Definir a variável $dados como array antes de usar
                $dados = [
                    ['id' => 4, 'sugestao' => '04. Nutrientes para saúde ocular: Vitaminas A e antioxidantes, além da taurina, são essenciais para proteger a visão e os tecidos nervosos. Mesmo em casos de perda total da visão, esses nutrientes contribuem para a saúde geral.', 'img_front' => '../img/flipcards/dvg7.png', 'img_back' => '../img/flipcards/dvg8.png'],

                    ['id' => 5, 'sugestao' => '05. Estimulação através de aromas: Oferecer alimentos com cheiro mais forte facilita a localização da comida e estimula o apetite. Aromas familiares também ajudam o gato a se sentir mais confiante durante a alimentação.', 'img_front' => '../img/flipcards/dvg9.png', 'img_back' => '../img/flipcards/dvg10.png'],

                    ['id' => 6, 'sugestao' => '06. Hidratação: Água fresca e limpa deve estar sempre disponível. Fontes de água em movimento são excelentes para incentivar o gato a beber mais, ajudando na saúde renal e no bem-estar geral.', 'img_front' => '../img/flipcards/dvg11.png', 'img_back' => '../img/flipcards/dvg12.png'],
                ];
                ?>
                ...
                <div class="adaptacoes" style="margin-top: 80px;">
                    ...
                    // Definir a variável $dados como array antes de usar
                    $dados = [
                        ['id' => 7, 'sugestao' => '07. Mobiliário estável: Evite mover móveis ou trocar objetos de lugar com frequência. A previsibilidade ajuda o gato a se deslocar com confiança e diminui o risco de esbarrões e quedas.', 'img_front' => '../img/flipcards/dvg13.png', 'img_back' => '../img/flipcards/dvg14.png'],

                        ['id' => 8, 'sugestao' => '08. Proteção: Redes de proteção em janelas e sacadas são indispensáveis. Também é importante eliminar objetos pontiagudos e perigosos que possam causar ferimentos durante a locomoção.', 'img_front' => '../img/flipcards/dvg15.png', 'img_back' => '../img/flipcards/dvg16.png'],

                        ['id' => 9, 'sugestao' => '09. Comedouros estratégicos: A posição da comida e da água deve ser sempre a mesma. Isso ajuda o gato a encontrá-los facilmente e evita frustrações. Evite recipientes que se movem com facilidade.', 'img_front' => '../img/flipcards/dvg17.png', 'img_back' => '../img/flipcards/dvg18.png'],
                    ];
                    ?>
