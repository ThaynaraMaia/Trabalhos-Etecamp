            ...
            <div class="row">
                <div class="nav2">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item">
                            <div class="col-sm">
                                <a href="../../frontend/parceiros/parceiros.php" class="nav-link"
                                    id="linksnav">Parceiros</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="col-sm">
                ...
                <div class="links">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="btnTipo">
                                <div>
                                    <a href="../../frontend/deficiencias/guiasc.php" class="cardMeu">
                                        <img src="../../img/cc.png" class="btndog" alt="...">
                                    </a>
                                </div>
                                <div>
                                    <a href="../../frontend/deficiencias/guiasg.php" class="cardMeu">
                ...
                <div class="guides-grid">
                    ...
                    foreach ($animais as $animal) {
                        ...
                        if ($tipo_animal === 'cachorro') {
                            // Exibir guias conforme as condições
                            if (strpos($condicoes, 'deficiencia visual') !== false): ?>
                                <div class="guide-card">
                                    <span class="guide-icon"><i class="fa-solid fa-eye-slash"></i> <i
                                            class="fa-solid fa-dog"></i></span>
                                    <h3>Deficiências Visuais</h3>
                                    <p>Cegueira, catarata, glaucoma e outras condições que afetam a visão do seu pet.</p>
                                    <a href="defvisc.php" class="guide-link">Acessar Guia</a>
                                </div>
                                <?php $exibeGuia = true;
                            endif;
                            ...
                            if (strpos($condicoes, 'deficiencia auditiva') !== false): ?>
                                <div class="guide-card">
                                    <span class="guide-icon"><i class="fa-solid fa-ear-deaf"></i> <i
                                            class="fa-solid fa-dog"></i></span>
                                    <h3>Deficiências Auditivas</h3>
                                    <p>Surdez parcial ou total, infecções do ouvido e como se comunicar com pets com problemas
                                        auditivos.</p>
                                    <a href="defaudc.php" class="guide-link">Acessar Guia</a>
                                </div>
                                <?php $exibeGuia = true;
                            endif;
                            ...
                            if (strpos($condicoes, 'deficiencia motora') !== false): ?>
                                <div class="guide-card">
                                    <span class="guide-icon"><i class="fa-solid fa-wheelchair"></i> <i
                                            class="fa-solid fa-dog"></i></span>
                                    <h3>Problemas de Mobilidade</h3>
                                    <p>Artrite, displasia, paralisia e outras condições que limitam o movimento. Equipamentos e
                                        exercícios adaptados.</p>
                                    <a href="defmotc.php" class="guide-link">Acessar Guia</a>
                                </div>
                                <?php $exibeGuia = true;
                            endif;
                            ...
                            if (strpos($condicoes, 'idoso') !== false || $animal['idade_animale'] >= 7): ?>
                                <div class="guide-card">
                                    <span class="guide-icon"><i class="fa-solid fa-person-cane"></i> <i
                                            class="fa-solid fa-dog"></i></span>
                                    <h3>Idosos</h3>
                                    <p>Processo biológico natural, caracterizado por alterações nos sistemas fisiológicos.</p>
                                    <a href="idosoc.php" class="guide-link">Acessar Guia</a>
                                </div>
                                <?php $exibeGuia = true;
                            endif;
                        }
                    ...
                    <?php if (!$exibeGuia): ?>
                        <div class="teste">
                            <div class="alertaa" role="alert">
                                Nenhum guia disponível para o tipo de animal ou condições cadastradas no seu pet.<br>
                                Se não tiver nenhum animal cadastrado ou se o tipo de animal não for compatível, cadastre
                                agora!
