...
<body>
    ...
    <a href="https://www.youtube.com/"><img src="../../img/igv.png" alt="" style="width: 500px; height: 300px; display: flex; flex-direction: column; align-items: center; margin-top: 50px;"></a>
    </div>
        ...
        <div class="links">
            <div class="row">
                ...
                <div class="col-8">
                    <div class="btnTipo">
                        <div>
                            <a href="../deficiencias/idosoc.php" class="card">
        ...
        <div class="introducao">
            <div class="row">
                <div class="col-2"></div>
                <div class="col-8">
                    <p style="text-align: justify;">Gatos são considerados geriátricos a partir dos 10 anos de idade, podendo viver até 20 anos ou mais com cuidados adequados. O envelhecimento felino apresenta particularidades como maior predisposição à doença renal crônica, hipertireoidismo, artrite (especialmente comum mas frequentemente não diagnosticada), alterações cognitivas e mudanças comportamentais. Gatos idosos tendem a ser mais sedentários, podem apresentar alterações no padrão de sono e mudanças nos hábitos de higiene pessoal.
                    </p>
                </div>
                <div class="col-2"></div>
            </div>
        ...
        <div class="cuidadosBasicos" style="margin-top: 80px;">
            ...
            $dados = [
                ['id' => 1, 'sugestao' => '01. Monitoramento comportamental: Gatos idosos podem apresentar mudanças sutis, como comer menos, dormir mais ou evitar interações. Observar esses sinais permite detectar problemas de saúde precocemente. Consultas regulares ajudam a acompanhar o envelhecimento com segurança.', 'img_front' => '../img/flipcards/gi1.png', 'img_back' => '../img/flipcards/gi2.png'],

                ['id' => 2, 'sugestao' => '02. Estimulação suave: Mesmo com menos energia, o gato precisa se movimentar. Brincadeiras leves e atividades curtas ajudam a manter o tônus muscular e o equilíbrio, sem sobrecarregar o corpo.', 'img_front' => '../img/flipcards/gi3.png', 'img_back' => '../img/flipcards/gi4.png'],

                ['id' => 3, 'sugestao' => '03. Assistência na higiene: Com o tempo, os gatos podem perder flexibilidade e ter dificuldade para se limpar. O tutor pode ajudar com escovações e limpeza das áreas de difícil alcance, evitando acúmulo de sujeira e infecções de pele.', 'img_front' => '../img/flipcards/gi5.png', 'img_back' => '../img/flipcards/gi6.png'],
            ];
            ?>
            ...
            <div class="nutricao" style="margin-top: 80px;">
                ...
                // Definir a variável $dados como array antes de usar
                $dados = [
                    ['id' => 4, 'sugestao' => '04. Ração sênior felina: As rações para gatos idosos têm proteínas de alta qualidade e fósforo controlado, protegendo rins e músculos. Elas ajudam a manter a energia e prevenir doenças comuns nessa fase.', 'img_front' => '../img/flipcards/gi7.png', 'img_back' => '../img/flipcards/gi8.png'],

                    ['id' => 5, 'sugestao' => '05. Suplementação renal: Ômega-3 e antioxidantes auxiliam na proteção dos rins e no controle de inflamações. Esses suplementos devem ser usados com orientação veterinária.', 'img_front' => '../img/flipcards/gi9.png', 'img_back' => '../img/flipcards/gi10.png'],

                    ['id' => 6, 'sugestao' => '06. Múltiplas refeições: Dividir a alimentação em pequenas porções ao longo do dia facilita a digestão e estimula o apetite. Essa prática também ajuda a manter o peso ideal e o bem-estar geral.', 'img_front' => '../img/flipcards/gi11.png', 'img_back' => '../img/flipcards/gi12.png'],
                ];
                ?>
                ...
                <div class="adaptacoes" style="margin-top: 80px;">
                    ...
                    // Definir a variável $dados como array antes de usar
                    $dados = [
                        ['id' => 7, 'sugestao' => '07. Caixas de areia acessíveis: Caixas com bordas baixas e localizadas em pontos estratégicos são essenciais. Isso facilita o uso e reduz o esforço das articulações, prevenindo acidentes e desconfortos.', 'img_front' => '../img/flipcards/gi13.png', 'img_back' => '../img/flipcards/gi14.png'],

                        ['id' => 8, 'sugestao' => '08. Acesso facilitado: Rampas e degraus pequenos ajudam o gato a alcançar locais favoritos, como sofás e janelas. Essas adaptações mantêm a independência e reduzem o risco de quedas.', 'img_front' => '../img/flipcards/gi15.png', 'img_back' => '../img/flipcards/gi16.png'],

                        ['id' => 9, 'sugestao' => '09. Comedouros elevados: Posicionar os potes de comida e água em uma altura confortável evita que o gato precise abaixar demais o pescoço. Isso traz mais conforto durante as refeições e melhora a digestão.', 'img_front' => '../img/flipcards/gi17.png', 'img_back' => '../img/flipcards/gi18.png'],
                    ];
                    ?>
