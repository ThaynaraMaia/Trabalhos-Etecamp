...
<head>
    ...
    <title>Deficiência Visual - Cachorro</title>
    <style>
        #areaSugestoes {
...
<body>
    ...
    <a href="https://www.youtube.com/"><img src="../../img/dvcv.png" alt="" style="width: 500px; height: 300px; display: flex; flex-direction: column; align-items: center; margin-top: 50px;"></a>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="btnTipo">
                        ...
                        <div>
                            <a href="../deficiencias/defvisg.php" class="card">
        ...
        <div class="introducao">
            <div class="row">
                <div class="col-2"></div>
                <div class="col-8">
                    <p style="text-align: justify;">A deficiência visual em cães pode variar desde a perda parcial até a cegueira total, sendo causada por condições como catarata madura, glaucoma, atrofia progressiva da retina, SARDS (Síndrome de Degeneração Aguda da Retina), diabetes, descolamento de retina ou traumatismos oculares. Felizmente, os cães possuem uma capacidade excepcional de adaptação, utilizando seus sentidos apurados de olfato, audição e tato para navegar pelo ambiente. Com orientação adequada e algumas adaptações, cães cegos podem manter uma vida completamente normal e ativa.
                    </p>
                </div>
                <div class="col-2"></div>
            </div>
        ...
        <div class="cuidadosBasicos" style="margin-top: 80px;">
            ...
            $dados = [
                ['id' => 1, 'sugestao' => '01. Comunicação constante: Cães com deficiência visual precisam de segurança e previsibilidade. Falar com o animal durante os deslocamentos ajuda a guiá-lo e evitar sustos. Usar sempre o tom de voz calmo e consistente cria confiança e facilita o reconhecimento do tutor.', 'img_front' => '../img/flipcards/cdv1.png', 'img_back' => '../img/flipcards/cdv2.png'],

                ['id' => 2, 'sugestao' => '02. Aproximação cuidadosa: Tocar o cão sem avisar pode causar sustos e reações defensivas. Sempre anuncie sua presença com a voz antes de se aproximar. Isso evita situações de estresse e faz o cão se sentir mais tranquilo e protegido.', 'img_front' => '../img/flipcards/cdv3.png', 'img_back' => '../img/flipcards/cdv4.png'],

                ['id' => 3, 'sugestao' => '03. Estímulos sensoriais: Brinquedos com sons, texturas e cheiros variados ajudam o cão a explorar o ambiente e se divertir de forma segura. Esses estímulos fortalecem o vínculo com o tutor e mantêm a mente ativa. Os brinquedos sensoriais podem ser comprados em sites como Amazon e Meu Doguinho, ou em lojas físicas da Cobasi e Petz.', 'img_front' => '../img/flipcards/cdv5.png', 'img_back' => '../img/flipcards/cdv6.png'],
            ];
            ?>
            ...
            <div class="nutricao" style="margin-top: 80px;">
                ...
                // Definir a variável $dados como array antes de usar
                $dados = [
                    ['id' => 4, 'sugestao' => '04. Antioxidantes: Vitaminas como A, C e E ajudam na proteção dos olhos e retardam a progressão de doenças oculares. Elas fortalecem a visão residual e devem ser usadas sob orientação veterinária.', 'img_front' => '../img/flipcards/cdv7.png', 'img_back' => '../img/flipcards/cdv8.png'],

                    ['id' => 5, 'sugestao' => '05. Ômega-3: O consumo de ômega-3 contribui para a saúde dos olhos e ajuda a reduzir inflamações. Pode ser encontrado em suplementos ou rações enriquecidas, sempre com acompanhamento profissional.', 'img_front' => '../img/flipcards/cdv9.png', 'img_back' => '../img/flipcards/cdv10.png'],

                    ['id' => 6, 'sugestao' => '06. Suplementação específica: Em alguns casos, o veterinário pode indicar suplementos voltados à saúde ocular, que ajudam na regeneração dos tecidos e na proteção dos nervos visuais.', 'img_front' => '../img/flipcards/cdv11.png', 'img_back' => '../img/flipcards/cdv12.png'],
                ];
                ?>
                ...
                <div class="adaptacoes" style="margin-top: 80px;">
                    ...
                    // Definir a variável $dados como array antes de usar
                    $dados = [
                        ['id' => 7, 'sugestao' => '07. Ambiente seguro e layout fixo: A rotina e o ambiente estável são essenciais. Evite mudar a posição de móveis, potes e camas, pois o cão memoriza o espaço e usa essa referência para se locomover. Um ambiente previsível transmite segurança e reduz o risco de acidentes.', 'img_front' => '../img/flipcards/cdv13.png', 'img_back' => '../img/flipcards/cdv14.png'],

                        ['id' => 8, 'sugestao' => '08. Estímulos olfativos: Utilizar aromas diferentes em cômodos específicos pode ajudar o cão a se orientar. Essências suaves ou produtos de limpeza com cheiros distintos facilitam a localização dentro da casa.', 'img_front' => '../img/flipcards/cdv15.png', 'img_back' => '../img/flipcards/cdv16.png'],

                        ['id' => 9, 'sugestao' => '09. Ambiente seguro: Escadas, sacadas e piscinas devem ter barreiras ou portões de segurança. Essas medidas evitam quedas e garantem que o cão possa circular com liberdade e segurança.', 'img_front' => '../img/flipcards/cdv17.png', 'img_back' => '../img/flipcards/cdv18.png'],
                    ];
                    ?>
